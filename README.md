...
- **Formulario de contacto (Formspree):** el formulario en `contacto.html` apunta a `https://formspree.io/f/TU_ID_AQUI`. Falta crear una cuenta gratuita en [formspree.io](https://formspree.io), crear un formulario que reenvíe a `estudioverde@gmail.com`, y reemplazar `TU_ID_AQUI` por el ID real antes de publicar el sitio.
